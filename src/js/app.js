...
setInterval(() => {
  switch (mode) {
    case 0:
      trs.sort((a, b) => a.dataset.id - b.dataset.id);
      th[0].textContent = 'id ↓';
      break;

    case 1:
      trs.sort((a, b) => b.dataset.id - a.dataset.id);
    ...
    case 4:
      trs.sort((a, b) => a.dataset.year - b.dataset.year);
      break;

    case 5:
      trs.sort((a, b) => b.dataset.year - a.dataset.year);
      break;

    case 6:
      trs.sort((a, b) => a.dataset.imdb - b.dataset.imdb);
      break;

    case 7:
      trs.sort((a, b) => b.dataset.imdb - a.dataset.imdb);
      break;
  }
